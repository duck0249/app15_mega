...
class App:
	...
	def submit_date(self):
		...
		currentaddress = self.entry_currentaddress.get()
		permanentaddress = self.entry_permanentaddress.get()

		self.web_automation = WebAutomation()
		self.web_automation.login(username, password)
		self.web_automation.fill_form(fullname, email, currentaddress, permanentaddress)
